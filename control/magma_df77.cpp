...
#define magmaf_dsyevx FORTRAN_NAME( magmaf_dsyevx, MAGMAF_DSYEVX )
void magmaf_dsyevx(
    char *jobz, char *range, char *uplo, magma_int_t *n,
...
#define magmaf_dsyevr FORTRAN_NAME( magmaf_dsyevr, MAGMAF_DSYEVR )
void magmaf_dsyevr(
    char *jobz, char *range, char *uplo, magma_int_t *n,
    double *a, magma_int_t *lda, double *vl, double *vu, magma_int_t *il, magma_int_t *iu, double *abstol,
    magma_int_t *m,
...
#define magmaf_dsygvx FORTRAN_NAME( magmaf_dsygvx, MAGMAF_DSYGVX )
void magmaf_dsygvx(
    magma_int_t *itype, char *jobz, char *range, char *uplo, magma_int_t *n,
    double *a, magma_int_t *lda,
...
#define magmaf_dsygvr FORTRAN_NAME( magmaf_dsygvr, MAGMAF_DSYGVR )
void magmaf_dsygvr(
    magma_int_t *itype, char *jobz, char *range, char *uplo, magma_int_t *n,
    double *a, magma_int_t *lda,
    double *b, magma_int_t *ldb, double *vl, double *vu, magma_int_t *il, magma_int_t *iu, double *abstol,
...
void magmaf_dtrsm_m(
    magma_int_t *nrgpu, char *side, char *uplo, char *transa, char *diag, magma_int_t *m, magma_int_t *n, double *alpha,
    double *a, magma_int_t *lda,
    double *b, magma_int_t *ldb )
{
    magma_dtrsm_m(
...
#define magmaf_dsytrd_sb2st FORTRAN_NAME( magmaf_dsytrd_sb2st, MAGMAF_DSYTRD_HB2ST )
...
#define magmaf_dsytrd_sy2sb FORTRAN_NAME( magmaf_dsytrd_sy2sb, MAGMAF_DSYTRD_HE2HB )
...
#define magmaf_dsyevx_gpu FORTRAN_NAME( magmaf_dsyevx_gpu, MAGMAF_DSYEVX_GPU )
    ...
    magma_int_t *info )
{
    magma_dsyevx_gpu(
        *jobz, *range, *uplo, *n,
        magma_ddevptr(da), *ldda, *vl, *vu, *il, *iu, *abstol,
        m,
        w,
        magma_ddevptr(dz), *lddz,
        wa, *ldwa,
        wz, *ldwz,
        work, *lwork,
        rwork,
...
#define magmaf_dsyevr_gpu FORTRAN_NAME( magmaf_dsyevr_gpu, MAGMAF_DSYEVR_GPU )
