/*
    -- MAGMA (version 1.2.1) --
       ...
       @generated d Thu Jun 28 12:30:41 2012
...
#define FLOPS(m, n) (      FMULS_GETRF(m, n) +      FADDS_GETRF(m, n) )
    ...
    *info = 0;
    ...
    for( I=0; I<n; I+=NB ) {
          ...
          magmablas_dsetmatrix_transpose_mgpu(num_gpus, (cudaStream_t **)stream, A(0,I), lda, 
          ...
          magmablas_dgetmatrix_transpose_mgpu(num_gpus, (cudaStream_t **)stream, dAT, ldn_local, A(0,I), lda,  dA, maxm, M, N, nb);
#ifdef PROFILE
          end1 = get_current_time();
