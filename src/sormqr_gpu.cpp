/*
    -- MAGMA (version 1.2.0) --
       ...
       @generated s Tue May 15 18:17:37 2012
...
/*  -- MAGMA (version 1.2.0) --
    ...
    *info = 0;
    ...
    if (i < k) {
        ...
        magma_sgetmatrix( mi, ib, a_ref(i,  i ), ldda, hwork, mi );
        magma_sgetmatrix( mi, ni, c_ref(ic, jc), lddc, hwork+mi*ib, mi );
        ...
        magma_ssetmatrix( mi, ni, hwork+mi*ib, mi, c_ref(ic, jc), lddc );
    }
