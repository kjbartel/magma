 ...
 *
 *     @generated c Fri Jun 28 19:32:36 2013
 *
 */
                        ...
                        magma_int_t *info)
{
    ...
    */
    ...
    magmaFloatComplex *dwork, *dT0, *dV0, *dT1, *dV1, *dwvt;
    ...
    if(MAGMA_SUCCESS != magma_cmalloc( &dwork, 2*lddwork*Vblksiz +  2*Vchunksiz* (Vblksiz* (lddv+lddt)) + lddwvt*Vblksiz )) {
                    ...
                    if((Vm>0)&&(Vn>0)){
                        ...
                        if(flip==0){
                            ...
                            for(magma_int_t i=0; i<NE; i+= sz_bl){
                                ib = min(sz_bl, NE-i);
                                //magma_clarfb_gpu( MagmaLeft, MagmaNoTrans, MagmaForward, MagmaColumnwise, Vm, ib, Vn, dV0+lcvpos, lddv, dT0+lctpos, lddt, dE(myrow,i), ldde, dwork, ib);
                                magma_clarfb_gpu_gemm( MagmaLeft, MagmaNoTrans, MagmaForward, MagmaColumnwise, Vm, ib, Vn, dV0+lcvpos, lddv, dT0+lctpos, lddt, dE(myrow,i), ldde, dwork, ib, dwvt, Vm);
                            }
                            ...
                            for(magma_int_t i=0; i<NE; i+= sz_bl){
                                ib = min(sz_bl, NE-i);
                                //magma_clarfb_gpu( MagmaLeft, MagmaNoTrans, MagmaForward, MagmaColumnwise, Vm, ib, Vn, dV1+lcvpos, lddv, dT1+lctpos, lddt, dE(myrow,i), ldde, dwork, ib);
                                magma_clarfb_gpu_gemm( MagmaLeft, MagmaNoTrans, MagmaForward, MagmaColumnwise, Vm, ib, Vn, dV1+lcvpos, lddv, dT1+lctpos, lddt, dE(myrow,i), ldde, dwork, ib, dwvt, Vm);
                            }
