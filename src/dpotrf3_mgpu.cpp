/*
    -- MAGMA (version 1.2.0) --
       ...
       @generated d Tue May 15 18:17:25 2012
...
magma_dpotrf3_mgpu(int num_gpus, char uplo, magma_int_t m, magma_int_t n, magma_int_t off_i, magma_int_t off_j, magma_int_t nb,
                   ...
                   double *a, magma_int_t lda, cudaStream_t stream[][3], magma_int_t *info ) 
{
/*  -- MAGMA (version 1.2.0) --
       Univ. of Tennessee, Knoxville
       Univ. of California, Berkeley
    ...
    cudaEvent_t event0[4], /* compute next block -> dsyrk     */
          ...
          for( d=0; d<num_gpus; d++ ) {
            ...
            if( j+jb < m && d == (j/nb+1)%num_gpus ) { 
              ...
              //if( j+jb < m ) 
              {
                ...
                /* note: dpotrf2_ooc copies only off-diagonal submatrices to cpu           */
...
magma_dhtodpo(int num_gpus, char *uplo, magma_int_t m, magma_int_t n, magma_int_t off_i, magma_int_t off_j, magma_int_t nb,
              double *a, magma_int_t lda, double **dwork, magma_int_t ldda, cudaStream_t stream[][3],
              magma_int_t *info) {
