...
#define PRECISION_c
  ...
  #define CTRSM_WORK
extern "C"
void magmablas_ctrsm_work( char side, char uplo, char tran, char diag, magma_int_t M, magma_int_t N,
                           cuFloatComplex alpha, const cuFloatComplex* A, magma_int_t lda, 
                           cuFloatComplex* b, magma_int_t ldb,
                           cuFloatComplex *d_dinvA, cuFloatComplex *d_x );
#endif
  ...
  #endif
  //#define magma_ctrsm magmablas_ctrsm /* caused sync error for upper-triangular on pluto */
  //#define CTRSM_WORK
extern "C"
void magmablas_ctrsm_work( char side, char uplo, char tran, char diag, magma_int_t M, magma_int_t N,
                           cuFloatComplex alpha, const cuFloatComplex* A, magma_int_t lda, 
...
magma_cpotrf3_mgpu(int num_gpus, char uplo, magma_int_t m, magma_int_t n, 
                   magma_int_t off_i, magma_int_t off_j, magma_int_t nb,
                   cuFloatComplex **d_lA,  magma_int_t ldda, 
                   cuFloatComplex **d_lP,  magma_int_t lddp, 
                   cuFloatComplex *a,      magma_int_t lda,   magma_int_t h,
...
/*  -- MAGMA (version 1.3.0) --
    ...
    cuFloatComplex *d_dinvA[MagmaMaxGPUs][2], *d_x[MagmaMaxGPUs][2]; /* used by ctrsm_work */
    ...
    *info = 0;
    ...
    {     
      ...
      for( d=0; d<num_gpus; d++ ) {
          magma_setdevice(d);
          for( j=0; j<2; j++ ) {
              cudaMalloc((void**)&d_dinvA[d][j], nb*nb*sizeof(cuFloatComplex));
              cudaMalloc((void**)&d_x[d][j],      n*nb*sizeof(cuFloatComplex));
              cudaMemset(d_dinvA[d][j], 0, nb*nb*sizeof(cuFloatComplex));
              cudaMemset(d_x[d][j],     0,  n*nb*sizeof(cuFloatComplex));
          }
      }
      magma_setdevice(0);
#endif
...
/* ======================================================================================== */
      ...
      for( d=0; d<num_gpus; d++ ) {
         ...
         for( j=0; j<2; j++ ) {
             cudaMalloc((void**)&d_dinvA[d][j], nb*nb*sizeof(cuFloatComplex));
             cudaMalloc((void**)&d_x[d][j],     nb*m *sizeof(cuFloatComplex));
             cudaMemset(d_dinvA[d][j], 0, nb*nb*sizeof(cuFloatComplex));
             cudaMemset(d_x[d][j],     0, nb* m*sizeof(cuFloatComplex));
         }
      }
      magma_setdevice(0);
#endif
...
extern "C" magma_int_t
magma_chtodpo(int num_gpus, char *uplo, magma_int_t m, magma_int_t n, 
              magma_int_t off_i, magma_int_t off_j, magma_int_t nb,
              cuFloatComplex *a,      magma_int_t lda, 
              cuFloatComplex **dwork, magma_int_t ldda, 
...
extern "C" magma_int_t
magma_cdtohpo(int num_gpus, char *uplo, magma_int_t m, magma_int_t n, 
