/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated s Wed Nov 14 22:53:06 2012
    ...
    *info = 0;
    ...
    for( I=0; I<n; I+=NB ) {
          ...
          if( M > I ) {
            ...
            magma_sgetrf2_mgpu(num_gpus, M-I, N, nb, I, dAT, ldn_local, ipiv+I, dA, &a[I*lda], lda,
                               stream, &iinfo);
            if( iinfo < 0 ) {
              *info = iinfo;
              break;
...
extern "C" magma_int_t
magma_sgetrf_piv(magma_int_t num_gpus0, magma_int_t m, magma_int_t n, float *a, magma_int_t lda, 
                 magma_int_t *ipiv, magma_int_t *info)
{
