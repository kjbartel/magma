...
extern "C" {
    void Mylapackf77_cstemr(char *jobz, char *range, magma_int_t *n, float *d, float *e,
    ...
    void Mylapackf77_sstebz(char *range, char *order, int *n, float *vl, 
...
magma_cheevr_gpu(char jobz, char range, char uplo, magma_int_t n, 
                 ...
                 float *w, cuFloatComplex *dz, magma_int_t lddz, magma_int_t *isuppz,
  ...
  if (! wantz) {
    ...
    if ((alleig || indeig && il == 1 && iu == n)){
      ...
      *m = n;
      ...
      lapackf77_sstebz(range_, "E", &n, &vl, &vu, &il, &iu, &abstol, &rwork[indrd], &rwork[indre], m,
