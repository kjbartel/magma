...
magma_cgetrf2_mgpu(magma_context *cntxt, magma_int_t num_gpus, 
                   ...
                   cuFloatComplex *d_lAP[4], cuFloatComplex *a, magma_int_t lda,
...
magma_cgetrf2_mgpu(magma_int_t num_gpus, 
         magma_int_t m, magma_int_t n, magma_int_t nb, magma_int_t offset,
         cuFloatComplex **d_lAT, magma_int_t lddat, magma_int_t *ipiv,
         cuFloatComplex **d_lAP, cuFloatComplex *w, magma_int_t ldw,
      ...
      for( i=0; i<s; i++ )
            {
                ...
                for( dd=0; dd<num_gpus; dd++ ) {
                  ...
                  magmablas_ctranspose(panel_local[d], ldpan[d], d_lAP[d], cols, cols, nb);
                  ...
                  if( d == (i+1)%num_gpus ) 
                  {
                    ...
                    if( nb0 > 0 ) {
                        ...
                        if( i+1 < s ) 
                          magmablas_ctranspose(  d_lAP[d], ldda, inAT(d,loff,i_local), lddat, nb0, ldda );
                        else
                          magmablas_ctranspose2(  d_lAP[d], ldda, inAT(d,loff,i_local), lddat, nb0, ldda );
              ...
              *info = iinfo + s*nb;
              ...
              for( d=0; d<num_gpus; d++ ) {
                ...
                if( d == id ) {
                  ...
                  magmablas_ctranspose2( panel_local[d], lddat, d_lAP[d], cols, rows, nb0);
                  ...
                  magmablas_ctranspose2( panel_local[d], nb, d_lAP[d], cols, rows, nb0);
                  //cublasCtrsm
                  magma_ctrsm( MagmaRight, MagmaUpper, MagmaNoTrans, MagmaUnit, 
                               nb1, nb0, c_one,
                               panel_local[d],     nb, 
