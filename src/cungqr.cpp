...
/*  -- MAGMA (version 1.1) --
    ...
    *info = 0;
    ...
    if (CUBLAS_STATUS_SUCCESS != 
        cublasAlloc((n)*ldda + nb*lddwork, sizeof(cuFloatComplex), (void**)&da)) 
      {
        *info = -11;
        ...
        for (i = ki; i >= 0; i-=nb)
          {
            ...
            cublasSetMatrix( i__2, ib, sizeof(cuFloatComplex),
                              a_ref(i, i), lda,
                             da_ref(i, i), ldda);
            ...
            cudaMemcpy2DAsync(da_ref(i,i), ldda * sizeof(cuFloatComplex),
                               a_ref(i,i), lda * sizeof(cuFloatComplex),
                              sizeof(cuFloatComplex)*i__2, ib,
                              cudaMemcpyHostToDevice, stream);

            /* Set rows 1:i-1 of current block to zero */
            i__2 = i + ib;
            magmablas_claset(MagmaUpperLower, i, i__2 - i, da_ref(0,i), ldda);
          }
      }

    cublasGetMatrix(m, n, sizeof(cuFloatComplex),
