/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated c Wed Nov 14 22:53:13 2012

*/
#include "common_magma.h"

extern"C"{
  void magmablas_csetdiag1subdiag0(char uplo, int k, int nb, cuFloatComplex *A, int lda);
}
        ...
        for (i__ = i1; i3 < 0 ? i__ >= i2 : i__ <= i2; i__ += i3) 
          {
            ...
            i__4 = nq - i__ + 1;
            lapackf77_clarft("F", "C", &i__4, &ib, &wa[i__ + i__ * ldwa], &ldwa, 
                             &tau[i__], t, &ib);
