...
magma_cgetrf2_mgpu(magma_int_t num_gpus, 
                   ...
                   cuFloatComplex **d_lAP, cuFloatComplex *a, magma_int_t lda,
    ...
    *info = 0;
    ...
    for( I=0; I<n; I+=NB ) {
          ...
          if( M > I ) {
            ...
            magma_cgetrf2_mgpu(num_gpus, M-I, N, nb, I, dAT, ldn_local, ipiv+I, dA, &a[I*lda], lda,
                               stream, &iinfo);
            if( iinfo < 0 ) {
              *info = iinfo;
              break;
...
extern "C" magma_int_t
magma_cgetrf_piv(magma_int_t num_gpus0, magma_int_t m, magma_int_t n, cuFloatComplex *a, magma_int_t lda, 
                 magma_int_t *ipiv, magma_int_t *info)
{
...
magma_cgetrf2_piv(magma_int_t m, magma_int_t n, magma_int_t start, magma_int_t end,
                  cuFloatComplex *a, magma_int_t lda, magma_int_t *ipiv, magma_int_t *info)
{
