/*
    -- MAGMA (version 1.2.1) --
       ...
       @generated d Thu Jun 28 12:30:33 2012
...
/*  -- MAGMA (version 1.2.1) --
    ...
    double *d_lP[MagmaMaxGPUs], *dlpanel;
    ...
    *info = 0;
    ...
    if ((nb <= 1) || (nb >= n)) {
      /*  Use unblocked code. */
          magma_setdevice(0);
      magma_dgetmatrix( n, n, dlA(0,0,0), ldda, work, n );
      lapackf77_dpotrf(uplo_, &n, work, &n, info);
      magma_dsetmatrix( n, n, work, n, dlA(0,0,0), ldda );
    } else {
