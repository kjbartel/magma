...
magma_chtodpo(int num_gpus, char *uplo, magma_int_t m, magma_int_t n, 
              ...
              cuFloatComplex  *h_A,  magma_int_t lda, 
...
magma_cdtohpo(int num_gpus, char *uplo, magma_int_t m, magma_int_t n, 
              ...
              cuFloatComplex **work, magma_int_t ldda, 
              cudaStream_t stream[][3], magma_int_t *info);
...
/*  -- MAGMA (version 1.3.0) --
    ...
    cuFloatComplex *dwork[MagmaMaxGPUs], *dt[MagmaMaxGPUs], *work;
...
//#define ROW_MAJOR_PROFILE
    ...
    *info = 0;
    ...
    magma_setdevice(0);
    ldwrk = n;
    if (MAGMA_SUCCESS != magma_cmalloc_pinned( &work, ldwrk*nb )) {
