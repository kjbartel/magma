...
extern "C" {
    void magma_dbulge_applyQ_v2(char side, magma_int_t NE, magma_int_t N, magma_int_t NB, magma_int_t Vblksiz, double *dE,
                                magma_int_t ldde, double *V, magma_int_t ldv, double *T, magma_int_t ldt, magma_int_t *info);

}

static void *magma_dapplyQ_parallel_section(void *arg);

static void magma_dtile_bulge_applyQ(char side, magma_int_t n_loc, magma_int_t n, magma_int_t nb, magma_int_t Vblksiz,
...
extern "C" magma_int_t magma_dbulge_back(magma_int_t threads, char uplo, magma_int_t n, magma_int_t nb, magma_int_t ne, magma_int_t Vblksiz,
    ...
    double timeaplQ2=0.0;
        ...
        omp_set_num_threads(1);
            ...
            if(n_gpu < ne)
            {
                ...
                magma_dapplyQ_id_data* arg = new magma_dapplyQ_id_data[threads];
...
static void *magma_dapplyQ_parallel_section(void *arg)
{
    ...
    sched_setaffinity( 0, sizeof(set), &set) ;
            ...
            if(my_core_id==0)
            {
                ...
                magma_dtile_bulge_applyQ('L', n_loc, n, nb, Vblksiz, E_loc, lde, V, ldv, TAU, T, ldt);
