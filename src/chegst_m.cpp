...
printf("hegs2%d\n", (int) k);
        ...
        if (upper) {
            ...
            printf("chegst_m: type2 upper not implemented\n");
            exit(-1);
...
*/
            ...
            printf("chegst_m: type2 lower not implemented\n");
            exit(-1);
...
/*                        if (n > nb){
            ...
            for (k = 0; k < nbl-1; ++k){
                ...
                if (k > 0){
                    for (igpu = 0; igpu < nrgpu; ++igpu){
                        ...
                        magma_cgemm(MagmaNoTrans, MagmaNoTrans, nloc[igpu], k*nb, kb, c_one, dA(igpu, n-nloc[igpu], k), ldda,
            ...
            for (igpu = 0; igpu < nrgpu; ++igpu){
                magma_setdevice(igpu);
                magma_csetmatrix_async( kb, // ERROR: missing dimension,
                                        A(k, 0),          lda,
