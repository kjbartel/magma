/*
 ...
 @generated d Wed Nov 14 22:53:26 2012
...
static void *magma_dsytrd_hb2st_parallel_section(void *arg);
...
extern "C" magma_int_t magma_dsytrd_hb2st(magma_int_t threads, char uplo, magma_int_t n, magma_int_t nb, magma_int_t Vblksiz,
                                          ...
                                          double *V, magma_int_t ldv, double *TAU, magma_int_t compT, double *T, magma_int_t ldt)
{
    ...
    magma_dbulge_id_data* arg = new magma_dbulge_id_data[threads];
    ...
    for (magma_int_t thread = 1; thread < threads; thread++)
    {
        ...
        pthread_create(&thread_id[thread], &thread_attr, magma_dsytrd_hb2st_parallel_section, &arg[thread]);
    }
    arg[0] = magma_dbulge_id_data(0, &data_bulge);
    magma_dsytrd_hb2st_parallel_section(&arg[0]);
