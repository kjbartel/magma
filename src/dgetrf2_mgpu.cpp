...
magma_dgetrf2_mgpu(magma_context *cntxt, magma_int_t num_gpus, 
                   ...
                   double *d_lAP[4], double *a, magma_int_t lda,
      ...
      for( i=0; i<s; i++ )
            {
                ...
                for( dd=0; dd<num_gpus; dd++ ) {
                  ...
                  magmablas_dtranspose(panel_local[d], ldpan[d], d_lAP[d], cols, cols, nb);
                  ...
                  if( d == (i+1)%num_gpus ) 
                  {
                    ...
                    if( nb0 > 0 ) {
                        ...
                        if( i+1 < s ) 
                          magmablas_dtranspose(  d_lAP[d], ldda, inAT(d,loff,i_local), lddat, nb0, ldda );
                        else
                          magmablas_dtranspose2(  d_lAP[d], ldda, inAT(d,loff,i_local), lddat, nb0, ldda );
              ...
              *info = iinfo + s*nb;
              ...
              for( d=0; d<num_gpus; d++ ) {
                ...
                if( d == id ) {
                  ...
                  magmablas_dtranspose2( panel_local[d], lddat, d_lAP[d], cols, rows, nb0);
                  ...
                  magmablas_dtranspose2( panel_local[d], nb, d_lAP[d], cols, rows, nb0);
                  //cublasDtrsm
                  magma_dtrsm( MagmaRight, MagmaUpper, MagmaNoTrans, MagmaUnit, 
                               nb1, nb0, c_one,
                               panel_local[d],     nb, 
