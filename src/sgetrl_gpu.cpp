/*
    -- MAGMA (version 1.1) --
       ...
       @generated s Sun Nov 13 20:48:31 2011
...
#define dL2(j)  (dL2 + (j)*ib*lddl         )
    ...
    *info = 0;
    ...
    if ( ib >= mindim ) {
        ...
        cublasSetMatrix(mindim, mindim, sizeof(float), hL2, ldhl, dL2, lddl);
#endif
        ...
        for( i=0; i<s; i++ )
        {
            ...
            if ( i>0 ){
                ...
                cublasGetMatrix( m, sb, sizeof(float), dwork, maxm, hA(0, i), ldha );
            ...
            cublasSetMatrix(sb, sb, sizeof(float), hL2(i), ldhl, dL2(i), lddl);
#endif
            // upload i-th panel
            cublasSetMatrix( rows, sb, sizeof(float), hA(i, i), ldha, dwork, cols);
