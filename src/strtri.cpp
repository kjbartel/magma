        ...
        *info = 0;
        ...
        else
        {
                if (upper)
                {
                        ...
                        {
                                jb = min(nb, (n-j));
                                cublasSetMatrix(jb, (n-j), sizeof( float), A(j, j), lda, dA(j, j), ldda);

                                /* Compute rows 1:j-1 of current block column */
                                cublasStrmm(MagmaLeft, MagmaUpper,
                                                        MagmaNoTrans, MagmaNonUnit, j, jb,
                                                        zone, dA(0,0), ldda, dA(0, j),ldda);

                                cublasStrsm(MagmaRight, MagmaUpper,
                                                        MagmaNoTrans, MagmaNonUnit, j, jb,
                                ...
                                cublasSetMatrix(jb, jb, sizeof( float),
                ...
                else
                {
                        ...
                        for(j=nn-1; j>=0; j=j-nb)
                        {
                                ...
                                if((j+jb) < n)
                                {
                                        ...
                                        cublasStrsm(MagmaRight, MagmaLower,
                                                        MagmaNoTrans, MagmaNonUnit, (n-j-jb), jb,
