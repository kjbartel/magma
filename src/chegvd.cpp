...
/*  -- MAGMA (version 1.1) --
    ...
    *info = 0;
    ...
    magma_chegst_gpu(itype, uplo_[0], n, da, ldda, db, lddb, info);
  
    magma_cheevd_gpu(jobz_[0], uplo_[0], n, da, ldda, w, a, lda, 
                     work, lwork, rwork, lrwork, iwork, liwork, info);
    /* Computing MAX */
    //    d__1 = (float) lopt, d__2 = work[1].r;
    //    lopt = (magma_int_t) max(d__1,d__2);
    /* Computing MAX */
    //    d__1 = (float) lropt;
    //    lropt = (magma_int_t) max(d__1,rwork[1]);
    /* Computing MAX */
    //    d__1 = (float) liopt, d__2 = (floatreal) iwork[1];
        ...
        if (itype == 1 || itype == 2) 
          {
            ...
            MycublasCtrsm(MagmaLeft, uplo_[0], *trans, MagmaNonUnit,
        ...
        } else if (itype == 3) 
          {
            ...
            MycublasCtrmm(MagmaLeft, uplo_[0], *trans, MagmaNonUnit, 
                          n, n, zone, db, lddb, da, ldda);
        }

        cublasGetMatrix(n, n, sizeof(cuFloatComplex), da, ldda, a, lda);
