/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated d Wed Nov 14 22:53:27 2012
...
extern "C" void dcheck_eig_(char *JOBZ, magma_int_t  *MATYPE, magma_int_t  *N, magma_int_t  *NB,
                       double* A, magma_int_t  *LDA, double *AD, double *AE, double *D1, double *EIG,
                    double *Z, magma_int_t  *LDZ, double *WORK, double *RWORK, double *RESU);
#endif


extern "C"  magma_int_t plasma_ceildiv(magma_int_t a, magma_int_t b);
extern "C"  void tile_bulge_applyQ_cpu(magma_int_t WANTZ, char SIDE, magma_int_t N, magma_int_t NB, magma_int_t Vblksiz, double *E, magma_int_t LDE, double *V, double *TAU, double *T, magma_int_t *INFO);
...
////////////////////////////////////////////////////////////////////////////////////////////////////          
/* START CODE */
extern "C" magma_int_t magma_dsytrd_bsy2trc( magma_int_t THREADS, magma_int_t WANTZ, char uplo, magma_int_t NE, magma_int_t N, magma_int_t NB, double *A1, magma_int_t LDA1, double *D2, double *E2, double *dT1, magma_int_t LDT1)
{
    char uplo_[2] = {uplo, 0};
