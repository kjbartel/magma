...
/*  -- MAGMA (version 1.2.0) --
    ...
    Purpose   
    =======   
    SSYBBD reduces a real symmetric matrix A to real symmetric   
    ...
    int ldda = ((n+31)/32)*32; // magma_get_ssybbd_nb(n); 
    int lddt = nb;
    ...
    *info = 0;
    ...
    if (upper) {
      ...
      printf("SSYBBD is not yet implemented for upper matrix storage. Exit.\n");
      exit(1);
