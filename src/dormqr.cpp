...
/*  -- MAGMA (version 1.2.1) --
    ...
    *info = 0;
    ...
    if (nb >= k) 
      {
        /* Use CPU code */
        lapackf77_dormqr(side_, trans_, &m, &n, &k, &a[a_offset], &lda, &tau[1],
        ...
        for (i__ = i1; i3 < 0 ? i__ >= i2 : i__ <= i2; i__ += i3) 
          {
            ...
            /* 1) Put 0s in the upper triangular part of A;
               ...
               3) restore A                                      */
            dpanel_to_q('U', ib, &a[i__ + i__ * lda], lda, t+ib*ib);
            magma_dsetmatrix( i__4, ib, &a[i__ + i__ * lda], lda, dwork, i__4 );
            dq_to_panel('U', ib, &a[i__ + i__ * lda], lda, t+ib*ib);
