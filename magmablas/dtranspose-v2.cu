...
//
extern "C" void 
magmablas_dtranspose2(double *odata, int ldo, 
                      ...
                      int m, int n )
{
    ...
    dtranspose3_32<<< grid, threads, 0, magma_stream >>>( odata, ldo, idata, ldi, 
                                         // m, m%32, n, n%32);
                       ...
                       int m, int n, cudaStream_t *stream )
{
    ...
    dim3 threads( DSIZE_1SHARED, 8, 1 );
    dim3 grid( (m+31)/32, (n+31)/32, 1 );
    dtranspose3_32<<< grid, threads, 0, *stream >>>( odata, ldo, idata, ldi,
                                         // m, m%32, n, n%32);
                                         m, (32-m%32)%32, n, (32-n%32)%32);
}
