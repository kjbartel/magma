/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated s Wed Nov 14 22:53:55 2012
...
__global__ void
magmablas_ssymv_200_L_special_mgpu_offset( magma_int_t n, float alpha,
                         ...
                         magma_int_t nb,
                         magma_int_t the_chosen_block_id,
                         magma_int_t the_chosen_gpu_id,
                         magma_int_t kstan)
{
 ...
 */
__global__ void
magmablas_ssymv_200_L_generic_mgpu_offset(magma_int_t n, float alpha,
                              float *A, magma_int_t lda,
                              float *x, magma_int_t incx,
                              float beta,
                              float *y, magma_int_t incy,
...
__global__ void
magmablas_ssymv_200_L_update_mgpu_offset(magma_int_t n, float alpha,
                         float* A, magma_int_t lda,
                         float *x, magma_int_t incx,
                         float beta,
                         float *y, magma_int_t incy,
...
extern "C"
void magmablas_ssymv_200_L_mgpu_offset(magma_int_t m, float alpha,
                           float *A, magma_int_t lda,
                           float *X, magma_int_t incx,
                           float beta,
                           float *Y, magma_int_t incy,
...
extern "C"
magma_int_t
magmablas_ssymv_mgpu_offset( char uplo, magma_int_t n,
                      float alpha,
                      float **A, magma_int_t lda,
                      float **X, magma_int_t incx,
                      float beta,
...
extern "C"
magma_int_t
magmablas_ssymv2_mgpu( char uplo, magma_int_t n,
                      float alpha,
                      float **A, magma_int_t lda,
                      float **X, magma_int_t incx,
                      float beta,
