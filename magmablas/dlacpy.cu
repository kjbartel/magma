/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated d Wed Nov 14 22:53:45 2012
...
extern "C" void 
magmablas_dlacpy( char uplo, magma_int_t m, magma_int_t n,
...
/*
  ...
  =====================================================================   */
    ...
    if ( (uplo == 'U') || (uplo == 'u') ) {
        ...
        dlacpy_kernel<<< grid, threads, 0, magma_stream >>> ( m, n, A, lda, B, ldb );
    }
}
