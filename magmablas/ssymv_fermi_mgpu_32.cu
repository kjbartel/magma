...
__global__ void
magmablas_ssymv_200_L_special_mgpu_offset_32( magma_int_t n, float alpha,
                         ...
                         magma_int_t kstan)
{
    ...
    magma_int_t break_d   =  ssymv_bs * blkc;
    ...
    if ( (blkc % num_gpus) == my_gpu_id) 
    {
        ...
        #pragma unroll
        for(magma_int_t j =0; j<ssymv_bs; j +=8)
 ...
 */
__global__ void
magmablas_ssymv_200_L_generic_mgpu_offset_32(magma_int_t n, float alpha,
                              float *A, magma_int_t lda,
                              float *x, magma_int_t incx,
                              float beta,
                              float *y, magma_int_t incy,
...
__global__ void
magmablas_ssymv_200_L_update_mgpu_offset_32(magma_int_t n, float alpha,
                         float* A, magma_int_t lda,
                         float *x, magma_int_t incx,
                         float beta,
                         float *y, magma_int_t incy,
                                                 ...
                                                 magma_int_t kstan )
{
    magma_int_t i;
    magma_int_t tx  = threadIdx.x ;
    magma_int_t ind = blockIdx.x * ssymv_bs + tx ;
    float Ca;
...
extern "C"
void magmablas_ssymv_200_L_mgpu_offset_32(magma_int_t m, float alpha,
                           float *A, magma_int_t lda,
                           float *X, magma_int_t incx,
                           float beta,
                           float *Y, magma_int_t incy,
...
__global__ void
magmablas_ssymv_200_U_special_mgpu_offset_32( magma_int_t n, float alpha,
                               float *A, magma_int_t lda,
                               float *x, magma_int_t incx,
                               float  beta,
                               float *y, magma_int_t incy,
...
__global__ void
magmablas_ssymv_200_U_generic_mgpu_offset_32(magma_int_t n, float alpha,
                              float *A, magma_int_t lda,
                              float *x, magma_int_t incx,
                              float beta,
                              float *y, magma_int_t incy,
...
__global__ void
magmablas_ssymv_200_U_update_mgpu_offset_32(magma_int_t n, float alpha,
                         float* A, magma_int_t lda,
                         float *x, magma_int_t incx,
                         float beta,
                         float *y, magma_int_t incy,
...
extern "C"
void magmablas_ssymv_200_U_mgpu_offset_32(magma_int_t m, float alpha,
                           float *A, magma_int_t lda,
                           float *X, magma_int_t incx,
                           float beta,
                           float *Y, magma_int_t incy,
...
extern "C"
magma_int_t
magmablas_ssymv_mgpu_32_offset( char uplo, magma_int_t n,
                      float alpha,
                      float **A, magma_int_t lda,
                      float **X, magma_int_t incx,
                      float beta,
...
extern "C"
magma_int_t
magmablas_ssymv2_mgpu_32( char uplo, magma_int_t n,
                      float alpha,
                      float **A, magma_int_t lda,
                      float **X, magma_int_t incx,
                      float beta,
...
__global__ void 
kernel_fillZero(float *A, magma_int_t size)
{
    magma_int_t id = blockIdx.x * blockDim.x + threadIdx.x;
    if(id < size)
    {
        MAGMA_S_SET2REAL(A[id], 0.0); 
    }
}


void fillZero(float *A, magma_int_t size)
{
