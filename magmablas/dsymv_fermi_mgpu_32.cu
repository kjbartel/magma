/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated d Wed Nov 14 22:53:54 2012
...
__global__ void
magmablas_dsymv_200_L_special_mgpu_offset_32( magma_int_t n, double alpha,
                         ...
                         magma_int_t kstan)
{
    ...
    magma_int_t break_d   =  dsymv_bs * blkc;
    ...
    if ( (blkc % num_gpus) == my_gpu_id) 
    {
        ...
        #pragma unroll
        for(magma_int_t j =0; j<dsymv_bs; j +=8)
 ...
 */
__global__ void
magmablas_dsymv_200_L_generic_mgpu_offset_32(magma_int_t n, double alpha,
                              double *A, magma_int_t lda,
                              double *x, magma_int_t incx,
                              double beta,
                              double *y, magma_int_t incy,
...
__global__ void
magmablas_dsymv_200_L_update_mgpu_offset_32(magma_int_t n, double alpha,
                         double* A, magma_int_t lda,
                         double *x, magma_int_t incx,
                         double beta,
                         double *y, magma_int_t incy,
                                                 ...
                                                 magma_int_t kstan )
{
    magma_int_t i;
    magma_int_t tx  = threadIdx.x ;
    magma_int_t ind = blockIdx.x * dsymv_bs + tx ;
    double Ca;
...
extern "C"
void magmablas_dsymv_200_L_mgpu_offset_32(magma_int_t m, double alpha,
                           double *A, magma_int_t lda,
                           double *X, magma_int_t incx,
                           double beta,
                           double *Y, magma_int_t incy,
...
__global__ void
magmablas_dsymv_200_U_special_mgpu_offset_32( magma_int_t n, double alpha,
                               double *A, magma_int_t lda,
                               double *x, magma_int_t incx,
                               double  beta,
                               double *y, magma_int_t incy,
...
__global__ void
magmablas_dsymv_200_U_generic_mgpu_offset_32(magma_int_t n, double alpha,
                              double *A, magma_int_t lda,
                              double *x, magma_int_t incx,
                              double beta,
                              double *y, magma_int_t incy,
...
__global__ void
magmablas_dsymv_200_U_update_mgpu_offset_32(magma_int_t n, double alpha,
                         double* A, magma_int_t lda,
                         double *x, magma_int_t incx,
                         double beta,
                         double *y, magma_int_t incy,
...
extern "C"
void magmablas_dsymv_200_U_mgpu_offset_32(magma_int_t m, double alpha,
                           double *A, magma_int_t lda,
                           double *X, magma_int_t incx,
                           double beta,
                           double *Y, magma_int_t incy,
...
extern "C"
magma_int_t
magmablas_dsymv_mgpu_32_offset( char uplo, magma_int_t n,
                      double alpha,
                      double **A, magma_int_t lda,
                      double **X, magma_int_t incx,
                      double beta,
...
extern "C"
magma_int_t
magmablas_dsymv2_mgpu_32( char uplo, magma_int_t n,
                      double alpha,
                      double **A, magma_int_t lda,
                      double **X, magma_int_t incx,
                      double beta,
...
__global__ void 
kernel_fillZero(double *A, magma_int_t size)
{
    magma_int_t id = blockIdx.x * blockDim.x + threadIdx.x;
    if(id < size)
    {
        MAGMA_D_SET2REAL(A[id], 0.0); 
    }
}


void fillZero(double *A, magma_int_t size)
{
