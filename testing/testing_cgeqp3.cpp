/*
    -- MAGMA (version 1.2.1) --
       ...
       @generated c Thu Jun 28 12:31:41 2012
...
int main( int argc, char** argv) 
{
    ...
    float           flops, gpu_perf, cpu_perf, gpu_time, cpu_time;
    ...
    //TESTING_MALLOC( h_R,  cuFloatComplex, n2   );
    ...
    for(i=0; i<10; i++){
        ...
        if (info < 0)
            printf("Argument %d of lapack_cgeqp3 had an illegal value.\n", -info);
        ...
        if (info < 0)
            printf("Argument %d of magma_cgeqp3 had an illegal value.\n", -info);
        ...
        if ( checkres ) 
            {
                ...
                result[0] = lapackf77_cqpt01(&M, &N, &minmn, h_A, h_R, &lda, 
