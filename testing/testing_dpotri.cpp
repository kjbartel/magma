 ...
 *     November 2011
 *
 * @generated d Sun Nov 13 20:48:49 2011
 *
 **/
// includes, system
#include <stdlib.h>
...
//        magma_dlauum(uplo[0], N, h_R, lda, &info);        
//        magma_dtrtri(uplo[0], MagmaNonUnit, N, h_R, lda, &info);
...
//         lapackf77_dlauum(uplo, &N, h_A, &lda, &info);
//         lapackf77_dtrtri(uplo,"Non-unit" ,&N, h_A, &lda, &info);
