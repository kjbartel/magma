...
int main( int argc, char** argv)
{
    ...
    n2  = lda * N; 
    if(NB<1)
        NB  = 64; //64; //magma_get_chebbd_nb(N);

    if(NE<1)
        NE  = N; //64; //magma_get_chebbd_nb(N);
...
*/
        ...
        /* ====================================================================
           ...
           =================================================================== */
        start = get_current_time();
       //magma_chebbd(uplo[0], N, h_R, lda, tau, h_work, lwork, &info);
        magma_chebbd(uplo[0], N, NB, h_R, lda, tau, h_work, lwork, dT1, &info);
        end = get_current_time();
...
*/        
        ...
        if ( info < 0 )
            printf("Argument %d of magma_chebbd had an illegal value\n", (int) -info);
