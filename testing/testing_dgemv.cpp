...
{        
    ...
    for( i=istart; i < iend; i = (int)((i+1)*1.1) )
    {
        ...
        cublasSetVector( Xm,    sizeof( double ), X, incx, dX, incx );
        cublasSetVector( Ym,    sizeof( double ), Y, incy, dY, incy );
        ...
        cublasGetVector( Ym, sizeof( double ), dY, incy, Ycublas, incy );
        ...
        cublasGetVector( Ym, sizeof( double ), dY, incx, Ymagma, incx );
        ...
        blasf77_daxpy( &Ym, &mzone, Ymagma, &incy, Ycublas, &incy);
