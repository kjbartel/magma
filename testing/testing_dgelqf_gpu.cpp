/*
    -- MAGMA (version 1.1) --
       ...
       @generated d Sun Nov 13 20:48:53 2011
...
int main( int argc, char** argv)
{
    ...
    if (argc != 1){
        ...
        if (N>0 && M>0)
            printf("  testing_dgelqf_gpu -M %d -N %d\n\n", M, N);
        else
            {
                printf("\nUsage: \n");
                printf("  testing_dgelqf_gpu -M %d -N %d\n\n", M, N);
    ...
    for(i=0; i<7; i++){
        ...
        /* ====================================================================
           ...
           =================================================================== */
        cublasSetMatrix( M, N, sizeof(double), h_R, lda, d_A, lda);
        start = get_current_time();
        magma_dgelqf_gpu( M, N, d_A, lda, tau, h_work, lwork, &info);
        end = get_current_time();
        if (info < 0)
            printf("Argument %d of magma_dgelqf_gpu had an illegal value.\n", -info);
        ...
        /* =====================================================================
           ...
           =================================================================== */
        cublasGetMatrix( M, N, sizeof(double), d_A, lda, h_R, lda);
