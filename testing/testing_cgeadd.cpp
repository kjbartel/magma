 ...
 *     November 2012
 *
 * @generated c Wed Nov 14 22:54:10 2012
 *
 * @author Mark Gates
 **/
// includes, system
...
int main( int argc, char** argv)
{
    ...
    float          error;
    cuFloatComplex *h_A, *h_B, *d_A, *d_B;
    cuFloatComplex alpha = MAGMA_C_MAKE( 3.1415, 2.718 );
    ...
    TESTING_HOSTALLOC( h_B, cuFloatComplex, lda *N );
    TESTING_DEVALLOC(  d_A, cuFloatComplex, ldda*N );
    TESTING_DEVALLOC(  d_B, cuFloatComplex, ldda*N );
