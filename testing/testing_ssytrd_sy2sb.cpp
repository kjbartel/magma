/*
    -- MAGMA (version 1.3.0) --
       ...
       @generated s Wed Nov 14 22:54:25 2012
...
extern "C" magma_int_t
magma_ssytrd_bsy2trc_v5(magma_int_t threads, magma_int_t wantz, char uplo, magma_int_t ne, magma_int_t n, magma_int_t nb,
...
*/
        ...
        /* ====================================================================
           ...
           =================================================================== */
        start = get_current_time();
        //magma_ssytrd_sy2sb(uplo[0], N, h_R, lda, tau, h_work, lwork, &info);
...
*/        
        ...
        if ( info < 0 )
            printf("Argument %d of magma_ssytrd_sy2sb had an illegal value\n", (int) -info);
