...
@{
    ...
    @{
        ...
        @{
            ...
            @defgroup magma_chesv_driver single-complex precision
            @defgroup magma_zhesv_driver double-complex precision
        @}
        ...
        @{
            ...
            @defgroup magma_chesv_comp single-complex precision
            @defgroup magma_zhesv_comp double-complex precision
        @}
        ...
        @{
            ...
            @defgroup magma_chesv_aux single-complex precision
            @defgroup magma_zhesv_aux double-complex precision
        @}
    @}
